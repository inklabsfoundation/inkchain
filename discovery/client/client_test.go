...
import (
	...
	"github.com/inklabsfoundation/inkchain/common/chaincode"
	...
	inkchaindisc "github.com/inklabsfoundation/inkchain/discovery"
...
func createDiscoveryService(sup *mockSupport) discovery.DiscoveryServer {
	conf := inkchaindisc.Config{TLS: true}
	...
	return inkchaindisc.NewService(conf, sup)
}
