...
import (
	...
	ctxt "github.com/inklabsfoundation/inkchain/common/configtx/test"
	ledger2 "github.com/inklabsfoundation/inkchain/common/ledger"
...
func setupLedgerAndValidator(t *testing.T) (ledger.PeerLedger, Validator) {
	viper.Set("peer.fileSystemPath", "/tmp/inkchain/validatortest")
