...
import (
	...
	mocklgr "github.com/inklabsfoundation/inkchain/common/mocks/ledger"
	mockpeer "github.com/inklabsfoundation/inkchain/common/mocks/peer"
	...
	plgr "github.com/inklabsfoundation/inkchain/protos/ledger/queryresult"
...
func finitMockPeer(chainIDs ...string) {
	...
	os.RemoveAll(filepath.Join(os.TempDir(), "inkchain"))
}
...
func initializeCC(t *testing.T, chainID, ccname string, ccSide *mockpeer.MockCCComm) error {
	...
	//be triggered by the chaincode stream.  We just expect an error from inkchain. Hence pass nil for done
