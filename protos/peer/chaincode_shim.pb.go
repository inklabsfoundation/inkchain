...
const (
	...
	ChaincodeMessage_TRANSFER_EXTRACT_FEE ChaincodeMessage_Type = 825
)
...
type TransferExtractFee struct {
	To          []byte `protobuf:"bytes,1,opt,name=to,proto3" json:"to,omitempty"`
	BalanceType []byte `protobuf:"bytes,2,opt,name=balanceType,proto3" json:"balanceType,omitempty"`
	Amount      []byte `protobuf:"bytes,3,opt,name=amount,proto3" json:"amount,omitempty"`
}

func (m *TransferExtractFee) Reset()                    { *m = TransferExtractFee{} }
func (m *TransferExtractFee) String() string            { return proto.CompactTextString(m) }
func (*TransferExtractFee) ProtoMessage()               {}
func (*TransferExtractFee) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{13} }

func (m *TransferExtractFee) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *TransferExtractFee) GetBalanceType() []byte {
	if m != nil {
		return m.BalanceType
	}
	return nil
...
func (m *TransferExtractFee) GetAmount() []byte {
	if m != nil {
		return m.Amount
	}
	return nil
...
type TransferExtractFeeInfo struct {
	TranSet []*TransferExtractFee `protobuf:"bytes,2,rep,name=tranSet" json:"tranSet,omitempty"`
}

func (m *TransferExtractFeeInfo) Reset()                    { *m = TransferExtractFeeInfo{} }
func (m *TransferExtractFeeInfo) String() string            { return proto.CompactTextString(m) }
func (*TransferExtractFeeInfo) ProtoMessage()               {}
func (*TransferExtractFeeInfo) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{14} }

func (m *TransferExtractFeeInfo) GetTranSet() []*TransferExtractFee {
	if m != nil {
		return m.TranSet
	}
	return nil
...
func (*IssueTokenInfo) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{15} }
...
func init() {
	...
	proto.RegisterType((*TransferExtractFee)(nil), "protos.TransferExtractFee")
	proto.RegisterType((*TransferExtractFeeInfo)(nil), "protos.TransferExtractFeeInfo")
...
var fileDescriptor3 = []byte{
	...
	,
}
