...
import (
	...
	common_utils "github.com/inkchain/inkchain/common/util"
	...
	"github.com/inkchain/inkchain/gossip/filter"
	"github.com/inkchain/inkchain/gossip/gossip/msgstore"
	"github.com/inkchain/inkchain/gossip/gossip/pull"
...
func (gc *gossipChannel) verifyBlock(msg *proto.GossipMessage, sender common.PKIidType) bool {
	...
	if err != nil {
		gc.logger.Warning("Received inkchainated block from", sender, "in DataUpdate:", err)
		return false
	}
	return true
}
