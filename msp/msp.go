...
// Membership service provider APIs for inkchain inkchain:
//
...
// to sign transactions, or inkchain endorser who wishes to sign proposal
// processing outcomes.
...
const (
	INKCHAIN ProviderType = iota // MSP is of INKCHAIN type
